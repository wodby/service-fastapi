# Python (FastAPI) service for Wodby

Use Python (FastAPI) as a reusable component in applications managed by Wodby.
This repository contains the service manifests and referenced files used by the
public Python (FastAPI) service in the Wodby catalog.
...
4. Reference `fastapi` from your stack manifest.
